...
const u8* wifista_ssid="hu iphone";							//路由器SSID号
const u8* wifista_password="12345678abcdefg"; 	//连接密码
//const u8* wifista_ssid="1000";							//路由器SSID号
//const u8* wifista_password="18664875691"; 	//连接密码
const u8* ipbuf="115.29.240.46";								//目标端IP
const u8* portnum="9000";												//目标端口号
/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
void wifi_regist_cloud(void)
{
		u8 p[100];
		//atk_8266_quit_trans();  
		sprintf((char*)p,"%s","ep=887DYA3PTX39LM34&pw=123456");//测试数据
...
u8 atk_8266_wifista_test(void)
{
	...
	while(atk_8266_send_cmd("AT+CIPMUX=0","OK",200));   //0：单连接，1：多连接
...
u8 atk_8266_wifiap_test(void)
{
	...
	delay_ms(1000);
	delay_ms(1000);
	atk_8266_send_cmd("AT+CWSAP=\"STM32 WIFI\",\"12345678\",1,4","OK",20);   //0：单连接，1：多连接
	atk_8266_send_cmd("AT+CIPMUX=1","OK",20);   //0：单连接，1：多连接
	atk_8266_send_cmd("AT+CIPSERVER=1,9000","OK",20);     //开启Server模式，端口号为8086
